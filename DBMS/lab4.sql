...
where userID in 
			  ...
			  (select cardNum from [Card] where balance<30000));

select name
from [User]   --3
where userID in 
              (select userID  from [UserCard] where cardNum in 
              (select cardNum from [Card] where cardTypeID in 
			  (select cardTypeID from [CardType]where name like ('%Debit%'))));

select * from [User]
where userID in       --4
              (select userID  from [UserCard] where cardNum in 
              (select cardNum from [Card] where cardNum in 
			  (select cardNum from [Transaction] where transType in 
			  (select transTypeID from [TransactionType] where typeName like'Failed'))));
...
where userID in 
              (select userID  from [UserCard] where cardNum in
			  (select cardNum from [Card] where balance in 
			  (select max(balance) from[Card]where balance not in(select max(balance) from[Card] ))));
...
where userID in       --8
              ...
              (select cardNum from [Card] where cardNum in 
			  (select cardNum from [Transaction] where transType in 
			  (select transTypeID from [TransactionType] where typeName !='Withdraw'and
			  userId in(select userID  from [User] where city='Lahore')
			  ))));

select city from [User] --9
where userID in 
              (select userID  from [UserCard] where cardNum in
			  (select cardNum from [Card] where balance in 
