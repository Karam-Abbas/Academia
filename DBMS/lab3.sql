...
select hotelname from hotel where city='London' order by hotelname DESC;
select hotelname from hotel where hotelname like '__t%';
...
select roomno ,hotelno from booking where datefrom>='2005'and datefrom <='2010';
select hotelno from room where roomno=1001 and type='single' and price between 20.0 and 40.0;
...
select hotelname from hotel right join room on hotel.hotelno=room.hotelno where type='family' or type='double';
select hotelname from hotel right join room on hotel.hotelno=room.hotelno where type='single' or type='double';

select roomno from booking where guestno=10003 or guestno=1007 and not guestno=1001 ;
