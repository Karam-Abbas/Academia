...
begin
	begin transaction
		if @cgpa>2.5
			begin
				insert into Registration (RollNumber, CourseID)values (@studentID,@courseID)
				commit transaction
			...
			begin
				...
				print 'Sorry you can not register your gpa < 2.5'
				return
			end
end

exec STURegistration 1,20,3.3